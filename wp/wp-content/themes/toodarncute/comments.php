...
<?php if ('open' == $post->comment_status) : ?>
    <div class="Post">
                          ...
                          <form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php"
                            ...
                            <?php if ($user_ID) : ?>
                                ...
                                <p><?php printf(__('Logged in as <a href="%1$s">%2$s</a>.', 'kubrick'), get_option('siteurl') . '/wp-admin/profile.php', $user_identity); ?>
                                    <a href="<?php echo wp_logout_url(get_permalink()); ?>"
                                       title="<?php _e('Log out of this account', 'kubrick'); ?>"><?php _e('Log out &raquo;', 'kubrick'); ?></a>
                                </p>
                            ...
                            <?php else : ?>
                                ...
                                <p><input type="text" name="author" id="author"
                                    ...
                                    <label for="author"><small><?php _e('Name', 'kubrick'); ?><?php if ($req) {
                                          _e("(required)", "kubrick");
                                        } ?></small></label></p>
                                ...
                                <p><input type="text" name="email" id="email"
                                    ...
                                    <label for="email"><small><?php _e('Mail (will not be published)', 'kubrick'); ?><?php if ($req) {
                                          _e("(required)", "kubrick");
                                        } ?></small></label></p>
                                ...
                                <p><input type="text" name="url" id="url"
                                          ...
                                          size="22" tabindex="3"/>
                                    <label for="url"><small><?php _e('Website', 'kubrick'); ?></small></label>
                                </p>
		...
		<span class="btn">
		  <span class="l"></span>
		  <span class="r"></span>
		  <span class="t"><?php _e('Submit Comment', 'kubrick'); ?></span>
		</span>
                                  </button>
