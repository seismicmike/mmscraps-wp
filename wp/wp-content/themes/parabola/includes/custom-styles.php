...
html {	font-size:<?php echo $parabola_fontsize ?>;
		word-spacing:<?php echo $parabola_wordspace ?>;
		letter-spacing:<?php echo $parabola_letterspace ?>;
...
<?php if ($parabola_tables == "Enable") { ?>
		...
		.entry-content tr th, .entry-content thead th {background:none;} .entry-content tr td {border:none;}
<?php } ?>
