...
function parabola_setup() {
	...
	if ($parabolas['parabola_editorstyle']) add_editor_style( "styles/editor-style.css" );
	...
	add_image_size( 'header', apply_filters( 'parabola_header_image_width', $parabolas['parabola_totalSize'] ), apply_filters( 'parabola_header_image_height', $parabolas['parabola_hheight'] ), apply_filters( 'parabola_header_crop', true ) );
	...
	$header_args = array(
		'flex-height' => true,
		'height' => $parabolas['parabola_hheight'],
		'flex-width' => true,
		'width' => $parabolas['parabola_totalSize'],
		'max-width' => 1920,
		'default-image' => '',
	);
